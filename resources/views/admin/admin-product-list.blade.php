        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="#">View Staff List</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="#">View User List</a>
            </div>
          </li>
        </ul>
    ...
    <div class="container">
      ...
      <div class="media" style="margin-top:50px">
        ...
        <div class="media-body">
          <a href="{{route('admin.product.update_form',['id' => $product->id])}}"> <h5 class="mt-0">Product Name : {{$product->product_name}}</h5></a>
